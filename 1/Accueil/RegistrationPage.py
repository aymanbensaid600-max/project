...
class RegistrationPage(QWidget):
    def __init__(self):
        ...
        self.setWindowTitle("Formulaire d'inscription - Cabinet Médical")
        ...
        title = QLabel("Formulaire d'inscription")
    ...
    def submit(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if data.get("success"):
                    print('good')
                    self.popup = CustomPopup(popup_type="success", message="Inscription réussie avec succès !")
                    self.popup.show_centered(self)  # Affiche le popup centré dans la fenêtre d'inscription
                    self.close()
                else:
